...
```bash
git remote add encore encore://ebc-media-hub-qsf2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/ebc-media-hub-qsf2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/ebc-media-hub-qsf2/settings/integrations/github)
